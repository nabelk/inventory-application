(function webpackUniversalModuleDefinition(root, factory) {
    ...
    else if (typeof define === 'function' && define.amd) define('Flowbite', [], factory);
...
*/
            ...
            /***/ 554: /***/ function (__unused_webpack_module, exports) {
                    ...
                    return (knownFormats[format] = {
                        parser: function parser(dateStr, locale) {
                            var dateParts = dateStr
                                ...
                                .reduce(function (dtParts, part, index) {
                        ...
                        formatter: function formatter(date, locale) {
                            var dateStr = partFormatters.reduce(function (str, fn, index) {
                                return (str += ''
                                    .concat(separators[index])
                                    .concat(fn(date, locale)));
                            }, '');
                ...
                function unregisterListeners(keyObj) {
                    ...
                    listeners.forEach(function (listener) {
                        removeEventListener.call.apply(
                            removeEventListener,
                            _toConsumableArray(listener),
                        );
                    });
                ...
                function processOptions(options, datepicker) {
                    ...
                    if (inOpts.orientation) {
                        ...
                        config.orientation = {
                            x:
                                orientation.find(function (x) {
                                    return x === 'left' || x === 'right';
                                }) || 'auto',
                            y:
                                orientation.find(function (y) {
                ...
                var View = /*#__PURE__*/ (function () {
                    function View(picker, config) {
                        ...
                        Object.assign(this, config, {
                            picker: picker,
                            element: parseHTML('<div class="datepicker-view flex"></div>')
                                .firstChild,
                            selected: [],
                        });
                                ...
                                if (result) {
                                    ...
                                    if (result.classes) {
                                        ...
                                        (_el$classList = el.classList).add.apply(
                                            _el$classList,
                                            _toConsumableArray(extraClasses),
                                        );
                    ...
                    return _createClass(DaysView, [
                        {
                            ...
                            value: function init(options) {
                                ...
                                _get(_getPrototypeOf(DaysView.prototype), 'init', this).call(
                                    this,
                                    options,
                                );
                            },
                            ...
                            value: function setOptions(options) {
                                ...
                                if (updateDOW) {
                                    Array.from(this.dow.children).forEach(function (el, index) {
                                        ...
                                        el.className = _this.daysOfWeekDisabled.includes(dow)
                        ...
                        },
                        {
                            ...
                            value: function render() {
                                ...
                                if (this.calendarWeeks) {
                                    ...
                                    Array.from(this.calendarWeeks.weeks.children).forEach(function (
                                        el,
                                        index,
                                    ) {
                                ...
                                Array.from(this.grid.children).forEach(function (el, index) {
                                    ...
                                    if (
                                        current < _this2.minDate ||
                                        current > _this2.maxDate ||
                                        _this2.disabled.includes(current)
                                    ) {
                                        classList.add(
                                            'disabled',
                                            'cursor-not-allowed',
                    ...
                    return _createClass(MonthsView, [
                        {
                            ...
                            value: function init(options) {
                                ...
                                _get(_getPrototypeOf(MonthsView.prototype), 'init', this).call(
                                    this,
                                    options,
                                );
                            },
                    ...
                    return _createClass(YearsView, [
                        {
                            ...
                            value: function init(options) {
                                ...
                                _get(_getPrototypeOf(YearsView.prototype), 'init', this).call(
                                    this,
                                    options,
                                );
                            },
                            ...
                            value: function setOptions(options) {
                                if (hasProperty(options, 'minDate')) {
                                    if (options.minDate === undefined) {
                                        ...
                                        this.minYear = startOfYearPeriod(
                                            options.minDate,
                                            this.step,
                                        );
                                ...
                                if (hasProperty(options, 'maxDate')) {
                                    if (options.maxDate === undefined) {
                                        ...
                                        this.maxYear = startOfYearPeriod(
                                            options.maxDate,
                                            this.step,
                                        );
                        ...
                        },
                        {
                            ...
                            value: function updateSelection() {
                                ...
                                this.selected = dates.reduce(function (years, timeValue) {
                                    return pushUnique(
                                        years,
                                        startOfYearPeriod(timeValue, _this.step),
                                    );
                                }, []);
                                if (rangepicker && rangepicker.dates) {
                                    this.range = rangepicker.dates.map(function (timeValue) {
                ...
                function triggerDatepickerEvent(datepicker, type) {
                    ...
                    datepicker.element.dispatchEvent(
                ...
                var Picker = /*#__PURE__*/ (function () {
                    function Picker(datepicker) {
                        ...
                        var template = pickerTemplate.replace(
                            /%buttonClass%/g,
                        ...
                        var _header$lastElementCh = _slicedToArray(
                        ...
                        },
                        {
                            ...
                            value: function show() {
                                ...
                                if (!datepicker.inline) {
                                    ...
                                    if (
                                        inputDirection !==
                                        getTextDirection(datepicker.config.container)
                                    ) {
                            ...
                            value: function place() {
                                ...
                                if (orientX === 'auto') {
                                    if (left < 0) {
                                        ...
                                        orientX =
                                            getTextDirection(inputField) === 'rtl'
                                                ? 'right'
                                                : 'left';
                                    }
                                }
                                ...
                                classList.add(
                                    'datepicker-orient-'.concat(orientY),
                                    'datepicker-orient-'.concat(orientX),
                                );
                ...
                function onClickOutside(datepicker, ev) {
                    ...
                    if (
                        findElementInEventPath(ev, function (el) {
                    ...
                    var newDates = inputDates.reduce(function (dates, dt) {
                        ...
                        if (config.pickLevel > 0) {
                            ...
                            if (config.pickLevel === 1) {
                                date = rangeEnd
                                    ? _dt.setMonth(_dt.getMonth() + 1, 0)
                                    : _dt.setDate(1);
                            } else {
                                date = rangeEnd
                                    ? _dt.setFullYear(_dt.getFullYear() + 1, 0, 0)
                                    : _dt.setMonth(0, 1);
                            }
                        }
                        if (
                                ...
                                var callback = format
                                    ? function (date) {
                                          return formatDate(
                                              date,
                                              format,
                                              _this.datepickers[0].config.locale,
                                          );
                                      }
                                    : function (date) {
                                          return new Date(date);
            ...
            /***/ 902: /***/ function (__unused_webpack_module, exports, __webpack_require__) {
                ...
                var Accordion = /** @class */ (function () {
                    function Accordion(accordionEl, items, options, instanceOptions) {
                        ...
                        this.init();
                        instances_1.default.addInstance(
                            'Accordion',
                            this,
                            this._instanceId,
                ...
                var Carousel = /** @class */ (function () {
                    ...
                    Carousel.prototype._setActiveItem = function (item) {
                        ...
                        if (this._indicators.length) {
                            ...
                            (_a = this._indicators[position].el.classList).add.apply(
                                _a,
                                this._options.indicators.activeClasses.split(' '),
                            );
                            (_b = this._indicators[position].el.classList).remove.apply(
                                _b,
                ...
                function initCopyClipboards() {
                    document
                        ...
                        .forEach(function ($triggerEl) {
                            ...
                            var contentType = $triggerEl.getAttribute(
                                'data-copy-to-clipboard-content-type',
                            );
                            var htmlEntities = $triggerEl.getAttribute(
                                'data-copy-to-clipboard-html-entities',
                            );
                            // check if the target element exists
                            if ($targetEl) {
                                if (
                                    !instances_1.default.instanceExists(
                                        'CopyClipboard',
                        ...
                        if (this._datepickerEl && !this._initialized) {
                            if (this._options.rangePicker) {
                                this._datepickerInstance =
                                    new flowbite_datepicker_1.DateRangePicker(
                                        this._datepickerEl,
                                        this._getDatepickerOptions(this._options),
                                    );
                            } else {
                                this._datepickerInstance = new flowbite_datepicker_1.Datepicker(
                                    this._datepickerEl,
                                    this._getDatepickerOptions(this._options),
                                );
                            }
                    ...
                    Datepicker.prototype.getDate = function () {
                        if (
                            ...
                            this._datepickerInstance instanceof
                                flowbite_datepicker_1.DateRangePicker
                        ) {
                    ...
                    document
                        ...
                        .forEach(function ($datepickerEl) {
                            if ($datepickerEl) {
                                ...
                                var autoselectToday = $datepickerEl.hasAttribute(
                                ...
                                var orientation =
                                    $datepickerEl.getAttribute('datepicker-orientation');
                ...
                var Drawer = /** @class */ (function () {
                    ...
                    Drawer.prototype.hide = function () {
                        ...
                        if (this._options.edge) {
                            ...
                            this._getPlacementClasses(this._options.placement).active.map(function (
                                c,
                            ) {
                                _this._targetEl.classList.remove(c);
                            });
                        ...
                        .forEach(function ($triggerEl) {
                            ...
                            if ($drawerEl) {
                                ...
                                if (drawer_1) {
                                    ...
                                    drawer_1.addEventListenerInstance(
                                        $triggerEl,
                                        'click',
                                        toggleDrawer,
                                    );
                        ...
                        .forEach(function ($triggerEl) {
                            ...
                            if ($drawerEl) {
                                ...
                                if (drawer_2) {
                                    ...
                                    drawer_2.addEventListenerInstance(
                                        $triggerEl,
                                        'click',
                                        hideDrawer,
                                    );
                ...
                var Dropdown = /** @class */ (function () {
                    ...
                    Dropdown.prototype.destroy = function () {
                        ...
                        if (this._options.triggerType === 'hover') {
                            triggerEvents.showEvents.forEach(function (ev) {
                                _this._triggerEl.removeEventListener(
                                    ev,
                                    _this._hoverShowTriggerElHandler,
                                );
                                _this._targetEl.removeEventListener(
                                    ev,
                                    _this._hoverShowTargetElHandler,
                                );
                            });
                    ...
                    Dropdown.prototype._handleClickOutside = function (ev, targetEl) {
                        ...
                        if (ignoreClickOutsideClass) {
                            var ignoredClickOutsideEls = document.querySelectorAll(
                                '.'.concat(ignoreClickOutsideClass),
                            );
                    ...
                    document.querySelectorAll('[data-input-counter]').forEach(function ($targetEl) {
                        ...
                        if ($targetEl) {
                            if (
                                ...
                                new InputCounter(
                                    $targetEl,
                                    $incrementEl ? $incrementEl : null,
                                    $decrementEl ? $decrementEl : null,
                                    {
                ...
                var Instances = /** @class */ (function () {
                    ...
                    Instances.prototype.addInstance = function (component, instance, id, override) {
                        ...
                        if (this._instances[component][id] && !override) {
                            console.warn(
                                'Flowbite: Instance with ID '.concat(id, ' already exists.'),
                            );
                            return;
                        }
                    ...
                    Instances.prototype.getInstance = function (component, id) {
                        ...
                        if (!this._instances[component][id]) {
                            console.warn(
                                'Flowbite: Instance with ID '.concat(id, ' does not exist.'),
                            );
                            return;
                        }
